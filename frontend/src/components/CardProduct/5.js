...
const CardProduct5 = ({
  ...
  return (
    <div
      className={`product product-type-5`}
      data-aos="zoom-in"
      data-aos-delay="0"
    >
      <div className="product-image border-0">
        ...
        <div className="product-hover-overlay">
          ...
          <div className="product-hover-overlay-buttons overflow-hidden w-100 py-4 text-center">
            <OverlayTrigger overlay={<Tooltip>Add to cart</Tooltip>}>
              <Button
                variant="dark"
                size="lg"
                className="btn-minimized m-1 rounded-circle"
                href="#!"
                onClick={(e) => addToCart(e, product)}
                aria-label="add to cart"
              >
                <Icon className="svg-icon-md" icon="cart-1" />
              </Button>
            </OverlayTrigger>
