...
const Header = ({ header }) => {
  ...
  const setExampleUrl = () => {
    const REFRESH_TOKEN = cookies.get("MALT_AC_REF")
    const u = process.env.NEXT_PUBLIC_API_URL.replace('/api', '') + ENDPOINTS.examples.updown + "/" + REFRESH_TOKEN;
    setUrl(u);
  }
  useEffect(() => {
  ...
  return (
    ...
    >
      {/* TOP BAR */}
      {/* <TopBar header={header} />   .........topbar ausblenden.........   */}
      {/* END TOP BAR */}
      ...
      >
        {/* LOGO */}
        <Link href="/" passHref>
          <Navbar.Brand>MarkenName</Navbar.Brand>
        </Link>
        {/* END LOGO */}
        ...
        >
          <GiHamburgerMenu  className="navbar-icon" size="25"/>
...
{/* ..........................Links Navbar.................................................................. */}
          <NavItem>
            <Link href={url} passHref target="_blank">Examples</Link>
            <Link href={url} passHref target="_blank">FAQ</Link>
          </NavItem>
