    ...
    <React.Fragment>
      <Container className="py-6">
        <Row>
          ...
          <Col xl="6">
            ...
            <h1 className="display-3 fw-bold mb-5">We are Henning</h1>
      ...
      <Container className="pt-4 pb-6">
        <Row className="mb-5">
          ...
          <Col xl="8">
            ...
            <h1 className="display-3 fw-bold mb-5">History of Henning</h1>
          </Col>
        </Row>
        <Row className="mb-5">
          <Col sm="4">
      ...
      <section className="py-6 bg-gray-100">
        <Container>
          <Row>
            <Col lg="5">
              <h2 className="mb-4">Henning's Milestones</h2>
        ...
        <Container>
          <Row>
            <Col lg="10" className="mx-auto text-center">
              <h2 className="mb-6">
                At Henning, we want the right choice to be as easy as putting on
                a great T-shirt
              </h2>
            </Col>
